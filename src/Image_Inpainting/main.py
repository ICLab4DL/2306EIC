...
def parse_args():
    ...
    parser.add_argument(
        '-test_path', '--test_path',
        type=str, default='Image_Inpainting/data/test_samples/',
        help='Where to output test images during training'
    )
        
    parser.add_argument(
        '-weight_path', '--weight_path',
        type=str, default='Image_Inpainting/data/logs/',
    ...
    parser.add_argument(
        '-vgg_path', '--vgg_path',
        type=str, default='Image_Inpainting/data/logs/vgg16.h5',
...
if __name__ == '__main__':
    ...
    if args.stage == 'finetune' and not args.checkpoint:
        raise AttributeError('you must supply a checkpoint file')
